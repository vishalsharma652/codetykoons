  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-8 py-32 md:py-16" id="home">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle,rgba(168,85,247,0.15)_0%,transparent_70%)] -bottom-[100px] -right-[100px] animate-float-orb-2" />
        <div className="absolute w-[300px] h-[300px] rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.12)_0%,transparent_70%)] top-1/2 left-1/2 animate-pulse-orb" />
      </div>
      ...
      <div className="relative z-10 text-center max-w-[820px] mx-auto">
        ...
        <h1 className="font-['Outfit'] text-[clamp(2.4rem,6vw,4.5rem)] font-extrabold text-white leading-[1.12] tracking-tight mb-6" ref={headingRef}>
        ...
        <p className="text-[clamp(1.05rem,2vw,1.2rem)] text-white/65 leading-[1.7] max-w-[600px] mx-auto mb-10">
        ...
        <div className="flex items-center justify-center gap-8 flex-wrap">
          <div className="flex flex-col items-center">
            ...
            <span className="text-[11px] text-white/50 uppercase tracking-widest mt-1">Projects Done</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-[11px] text-white/50 uppercase tracking-widest mt-1">Core Services</span>
          </div>
          <div className="w-[1px] h-10 bg-white/15" />
          <div className="flex flex-col items-center">
            ...
            <span className="text-[11px] text-white/50 uppercase tracking-widest mt-1">Client Focused</span>
          </div>
        </div>
      </div>

      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/35 text-[11px] tracking-widest z-10 animate-bounce">
        <div className="w-[22px] h-[34px] border-2 border-white/25 rounded-xl flex justify-center pt-1.5">
